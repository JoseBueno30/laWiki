...
class InlineResponse200(BaseModel):
    ...
    five_count: Optional[StrictInt] = None
    four_count: Optional[StrictInt] = None
    three_count: Optional[StrictInt] = None
    two_count: Optional[StrictInt] = None
    one_count: Optional[StrictInt] = None
    total: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["average", "five_count", "four_count", "three_count", "two_count", "one_count", "total"]
