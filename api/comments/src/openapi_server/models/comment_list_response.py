...
class CommentListResponse(BaseModel):
    ...
    next: Optional[StrictStr] = Field(default=None, description="The url to request the next batch of results")
    previous: Optional[StrictStr] = Field(default=None, description="The url to request the previous batch of results")
