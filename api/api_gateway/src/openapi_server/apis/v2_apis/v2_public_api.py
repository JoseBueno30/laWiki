...
async def get_article_average_rating(
    ...
    if not BaseV2PublicApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseV2PublicApi.subclasses[0]().get_article_average_rating(id)
...
async def get_article_comments(
    ...
    if not BaseV2PublicApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseV2PublicApi.subclasses[0]().get_article_comments(article_id, order, limit, offset, creation_date)
...
async def get_article_from_specific_wiki(
    ...
    if not BaseV2PublicApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseV2PublicApi.subclasses[0]().get_article_from_specific_wiki(wiki_name, article_name, lan)
...
async def get_article_version_body_by_id(
    ...
    if not BaseV2PublicApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseV2PublicApi.subclasses[0]().get_article_version_body_by_id(id, parsed, lan)
...
async def get_article_version_by_id(
    ...
    if not BaseV2PublicApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseV2PublicApi.subclasses[0]().get_article_version_by_id(id, lan)
...
async def get_article_version_list_by_article_id(
    ...
    if not BaseV2PublicApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseV2PublicApi.subclasses[0]().get_article_version_list_by_article_id(id, offset, limit, order)
...
async def get_articles_commented_by_user(
    ...
    if not BaseV2PublicApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseV2PublicApi.subclasses[0]().get_articles_commented_by_user(id, offset, limit, order)
...
async def get_articles_tags(
    ...
    if not BaseV2PublicApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseV2PublicApi.subclasses[0]().get_articles_tags(id, limit, offset)
...
async def get_rating(
    ...
    if not BaseV2PublicApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseV2PublicApi.subclasses[0]().get_rating(id)
...
async def get_ratings_bu_user_on_article(
    ...
    if not BaseV2PublicApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseV2PublicApi.subclasses[0]().get_ratings_bu_user_on_article(articleId, userId)
...
async def get_tag(
    ...
    if not BaseV2PublicApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseV2PublicApi.subclasses[0]().get_tag(id)
...
async def get_users_comments(
    ...
    if not BaseV2PublicApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseV2PublicApi.subclasses[0]().get_users_comments(user_id, article_id, order, limit, offset, creation_date)
...
async def get_wiki(
    ...
    if not BaseV2PublicApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseV2PublicApi.subclasses[0]().get_wiki(id_name, lang)
...
async def get_wiki_tags(
    ...
    if not BaseV2PublicApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseV2PublicApi.subclasses[0]().get_wiki_tags(id, limit, offset)
