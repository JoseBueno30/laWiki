...
class Author(BaseModel):
    """
    Author object contained in a comment response
    """ # noqa: E501
    id: StrictStr = Field(description="The unique ID of the user author")
    name: StrictStr = Field(description="The username of the user")
    image: StrictStr = Field(description="The avatar image of the user")
