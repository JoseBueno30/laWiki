...
class AuthorV1(BaseModel):
    """
    The author of an Article or ArticleVersion.
    """ # noqa: E501
    id: StrictStr = Field(description="The ID of the author.")
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of AuthorV1 from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of AuthorV1 from a dict"""
        if obj is None:
            return None
