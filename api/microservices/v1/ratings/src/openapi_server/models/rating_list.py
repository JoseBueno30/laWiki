...
class RatingList(BaseModel):
    """
    List of Ratings. Supports pagination.
    """ # noqa: E501
    ratings: List[Rating]
    ...
    __properties: ClassVar[List[str]] = ["ratings", "total", "offset", "limit", "next", "previous"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of RatingList from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of RatingList from a dict"""
        if obj is None:
            return None
