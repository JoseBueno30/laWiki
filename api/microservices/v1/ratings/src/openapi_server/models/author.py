...
class Author(BaseModel):
    """
    The author of a Rating
    """ # noqa: E501
    id: StrictStr = Field(description="Author's ID on database")
    name: StrictStr = Field(description="Author's name ")
    image: StrictStr = Field(description="Author's profile image")
