...
def test_get_article_by_author_v3(client: TestClient):
    """Test case for get_article_by_author_v3
    ...
    #    "GET",
    #    "/v3/articles/author/{id}".format(id='id_example'),
    #    headers=headers,
    #    params=params,
    #)
...
def test_get_article_by_id_v3(client: TestClient):
    """Test case for get_article_by_id_v3
...
def test_get_article_by_name_v3(client: TestClient):
    """Test case for get_article_by_name_v3
    ...
    #response = client.request(
    #    "GET",
    #    "/v3/articles/versions/by-name/{name}".format(name='name_example'),
    #    headers=headers,
    #    params=params,
    #)
...
def test_get_article_version_body_by_idv3(client: TestClient):
    """Test case for get_article_version_body_by_idv3
    ...
    #response = client.request(
    #    "GET",
    #    "/v3/articles/versions/{id}/body".format(id='id_example'),
    #    headers=headers,
    #    params=params,
    #)
...
def test_get_article_version_by_id_v3(client: TestClient):
    """Test case for get_article_version_by_id_v3
...
def test_get_article_version_list_by_article_idv3(client: TestClient):
    """Test case for get_article_version_list_by_article_idv3
...
def test_get_articles_commented_by_user_v3(client: TestClient):
    """Test case for get_articles_commented_by_user_v3
    ...
    #response = client.request(
    #    "GET",
    #    "/v3/articles/commented_by/{id}".format(id='id_example'),
    #    headers=headers,
    #    params=params,
    #)
...
def test_search_articles_v3(client: TestClient):
    """Test case for search_articles_v3
