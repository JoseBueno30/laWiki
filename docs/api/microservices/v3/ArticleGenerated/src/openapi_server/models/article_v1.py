...
class ArticleV1(BaseModel):
    ...
    author: AuthorV1
    tags: List[TagV1] = Field(description="Array of the tags of the article. The same as the array of tags of the most recent version.")
    versions: List[SimplifiedArticleVersionV1] = Field(description="Array of simplified articleversions")
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ArticleV1 from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of ArticleV1 from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "versions": [SimplifiedArticleVersionV1.from_dict(_item) for _item in obj.get("versions")] if obj.get("versions") is not None else None,
