...
async def create_article_v1(
    new_article_v1: Optional[NewArticleV1] = Body(None, description=""),
) -> ArticleV1:
...
async def create_article_version_v1(
    ...
    new_article_version_v1: Optional[NewArticleVersionV1] = Body(None, description=""),
) -> ArticleVersionV1:
...
async def delete_article_by_idv1(
    ...
    if not BaseV1EditorsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseV1EditorsApi.subclasses[0]().delete_article_by_idv1(id)
...
async def delete_article_version_by_id_v1(
    ...
    if not BaseV1EditorsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseV1EditorsApi.subclasses[0]().delete_article_version_by_id_v1(id)
...
async def restore_article_version_v1(
    ...
    if not BaseV1EditorsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseV1EditorsApi.subclasses[0]().restore_article_version_v1(article_id, version_id)
