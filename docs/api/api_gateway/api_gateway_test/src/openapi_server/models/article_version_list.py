...
class ArticleVersionList(BaseModel):
    """
    List of ArticleVersions. Supports pagination.
    """ # noqa: E501
    article_versions: List[SimplifiedArticleVersion]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ArticleVersionList from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of ArticleVersionList from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "article_versions": [SimplifiedArticleVersion.from_dict(_item) for _item in obj.get("article_versions")] if obj.get("article_versions") is not None else None,
            "total": obj.get("total"),
