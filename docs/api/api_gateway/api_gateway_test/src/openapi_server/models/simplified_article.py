...
class SimplifiedArticle(BaseModel):
    ...
    name: StrictStr = Field(description="The original name of the article.")
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of SimplifiedArticle from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of SimplifiedArticle from a dict"""
        if obj is None:
            return None
